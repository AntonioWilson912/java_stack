...
<body>
	<div class="container">
		<h1 class="text-purple">Book Club</h1>
		<p class="subtitle">A place for friends to share thoughts on books.</p>
	</div>
			...
			<div class="col">
				...
				<form:form action="/register" method="post" modelAttribute="newUser" cssClass="form">
					...
					<div class="form-group">
						<form:label path="name" cssClass="col">Name</form:label>
						<form:input path="name" cssClass="col" />
					</div>
